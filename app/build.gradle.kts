plugins {
    ...
    id("androidx.navigation.safeargs.kotlin") version "2.10.1"
}
...
dependencies {
    ...
    implementation("androidx.navigation:navigation-dynamic-features-fragment:2.10.1")
    ...
    debugImplementation("androidx.fragment:fragment-testing-manifest:1.9.0")
